...
import { GatewayTimeout } from "../../standard/http.js";
 ...
 *
 * > [!NOTE]
 * > `504` is one of the transient statuses {@link throttle} retries: declaring this middleware after it bounds each
 * > attempt on its own, while declaring it before bounds the retry sequence as a whole.
 *
