...
import { createThrottle } from "../async/index.js";
 ...
 * > responses into rejections, as {@link success} does: a failure already reported as a {@link Problem} is no longer a
 * > response and is relayed to the caller without being retried.
 * >
 * > ```typescript
