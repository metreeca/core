...
- `@metreeca/core/structures` module renamed to `@metreeca/core/values`; the `equals`, `immutable` and `seal`
...
- `difference` function for reducing collections to their set difference, keeping the elements of the first collection
  absent from every other one, deduplicating by `Set` identity by default or by an optional custom equality, exported
...
- Publishing and documentation workflows updated to Node.js 24 action runtimes; no library changes

## [0.9.20](https://github.com/metreeca/core/compare/v0.9.19...v0.9.20) - 2026-08-26
